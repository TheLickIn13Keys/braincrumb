  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to Braincrumb!",
      })
      ...
      {password && (
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <div className={`h-1 flex-1 rounded ${password.match(/[A-Z]/) ? 'bg-green-500' : 'bg-gray-200'}`} />
            <div className={`h-1 flex-1 rounded ${password.match(/[0-9]/) ? 'bg-green-500' : 'bg-gray-200'}`} />
            <div className={`h-1 flex-1 rounded ${password.match(/[^A-Za-z0-9]/) ? 'bg-green-500' : 'bg-gray-200'}`} />
          </div>
